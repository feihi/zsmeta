...
return array (
  ...
  'ADMIN_PLATSET_INFO' => '平台信息',
  'ADMIN_PLATSET_INFOPOST' => '平台信息设置提交',
  ...
  'JOB_ADMININDEX_DEFAULT' => '岗位管理',
  'JOB_ADMINJOB_ADD' => '添加岗位',
  'JOB_ADMINJOB_ADDPOST' => '添加岗位提交',
  'JOB_ADMINJOB_DELETE' => '岗位删除',
  'JOB_ADMINJOB_ECHART' => '折线图',
  'JOB_ADMINJOB_EDIT' => '编辑岗位',
  'JOB_ADMINJOB_EDITPOST' => '编辑岗位提交',
  'JOB_ADMINJOB_INDEX' => '岗位管理',
  'JOB_ADMINJOB_LISTORDER' => '岗位排序',
  'JOB_ADMINJOB_PUBLISH' => '岗位发布',
  'JOB_ADMINJOB_RECOMMEND' => '岗位推荐',
  'JOB_ADMINJOB_TOP' => '岗位置顶',
  'JOB_ADMINJOBAPPLY_ADD' => '添加岗位',
  'JOB_ADMINJOBAPPLY_ADDPOST' => '添加岗位提交',
  'JOB_ADMINJOBAPPLY_DEAL' => '处理岗位报名',
  'JOB_ADMINJOBAPPLY_DELETE' => '删除岗位报名',
  'JOB_ADMINJOBAPPLY_EDIT' => '编辑岗位',
  'JOB_ADMINJOBAPPLY_EDITPOST' => '编辑岗位提交',
  'JOB_ADMINJOBAPPLY_INDEX' => '报名记录',
  'JOB_ADMINJOBCATEGORY_ADD' => '添加岗位分类',
  'JOB_ADMINJOBCATEGORY_ADDPOST' => '添加岗位分类提交',
  'JOB_ADMINJOBCATEGORY_DELETE' => '删除岗位分类',
  'JOB_ADMINJOBCATEGORY_EDIT' => '编辑岗位分类',
  'JOB_ADMINJOBCATEGORY_EDITPOST' => '编辑岗位分类提交',
  'JOB_ADMINJOBCATEGORY_INDEX' => '分类管理',
  'JOB_ADMINJOBCATEGORY_LISTORDER' => '岗位分类排序',
  'JOB_ADMINJOBCATEGORY_SELECT' => '岗位分类选择对话框',
  'JOB_ADMINJOBCATEGORY_TOGGLE' => '岗位分类显示隐藏',
  'JOB_ADMINJOBREFEE_INFO' => '返费名单',
  'JOB_ADMINJOBREFEE_INFOPOST' => '返费名单设置提交',
  'JOB_ADMINJOBTAG_ADD' => '添加岗位标签',
  'JOB_ADMINJOBTAG_ADDPOST' => '添加岗位标签提交',
  'JOB_ADMINJOBTAG_DELETE' => '删除岗位标签',
  'JOB_ADMINJOBTAG_INDEX' => '岗位标签',
  'JOB_ADMINJOBTAG_UPSTATUS' => '更新标签状态',
  'PLUGIN/DCOMMENT_ADMININDEX_INDEX' => '岗位评论',
  'PLUGIN/HZBACKSQL_ADMININDEX_INDEX' => '数据备份',
